...
namespace std_impl {
    ...
    template <typename T, impl::unique_ptr::deleter Deleter>
    constexpr std_impl::unique_ptr<T, Deleter>::unique_ptr(
        pointer ptr, const deleter_type& deleter) noexcept :
        storage_(ptr, deleter) {
    }

    template <typename T, impl::unique_ptr::deleter Deleter>
    constexpr std_impl::unique_ptr<T, Deleter>::unique_ptr(
        pointer ptr, deleter_type&& deleter) noexcept :
    ...
    template <impl::unique_ptr::complete_type T, impl::unique_ptr::deleter Deleter>
    auto std_impl::unique_ptr<T[], Deleter>::operator=(unique_ptr&& other) noexcept
        -> unique_ptr& {
        reset(other.release());
        storage_.deleter() = std::forward<deleter_type>(other.get_deleter());
        return *this;
    ...
    template <typename T, impl::unique_ptr::deleter Deleter>
    constexpr auto std_impl::unique_ptr<T, Deleter>::get_deleter(this auto&& self) noexcept
        -> decltype(auto) {
    ...
    template <impl::unique_ptr::complete_type T, impl::unique_ptr::deleter Deleter>
    auto std_impl::unique_ptr<T[], Deleter>::operator[](std::size_t index) const noexcept
        -> element_type&
