...
namespace std_impl::optional {
    ...
    export template <typename T, typename U>
    concept not_same_optional_ref_argument =
        not std::is_same_v<std::remove_cvref_t<U>, optional<T&>>;

    export template <typename T, typename U>
    concept not_bool_optional_ambiguity =
        not std::is_same_v<T, bool> or not is_optional<std::remove_cvref_t<U>>;

    export template <typename T, typename U>
    concept constructible_from_external_value = std::constructible_from<T, U>
        and not_in_place_argument<U> and not_same_optional_argument<T, U>
        and not_nullopt_argument<U> and not_bool_optional_ambiguity<T, U>;
    ...
    export template <typename T, typename U>
    concept bool_or_non_converting_from_optional =
        std::is_same_v<T, bool> or not converts_from_any_cvref<T, optional<U>>;

    export template <typename T, typename U, typename Value>
    concept constructible_from_other_optional =
        std::constructible_from<T, Value> and bool_or_non_converting_from_optional<T, U>;
    ...
    export template <typename T, typename U>
    concept not_same_reference_type = not std::is_same_v<T&, U>;

    export template <typename T, typename U>
    concept constructible_ref_from_external_value =
        not_same_optional_ref_argument<T, U> and not_in_place_argument<U>
        and not_nullopt_argument<U> and binds_reference_without_temporary<T&, U>;

    export template <typename T, typename U>
    concept assignable_ref_from_external_value =
        not_same_optional_ref_argument<T, U> and binds_reference_without_temporary<T&, U>;

    export template <typename T, typename U, typename Value>
    concept constructible_ref_from_other_optional = not_same_optional_type<U>
        and not_same_reference_type<T, U> and binds_reference_without_temporary<T&, Value>;
    ...
    export template <typename T, typename U>
    concept optional_value_equal_comparable =
        not is_optional<std::remove_cvref_t<U>> and optional_values_equal_comparable<T, U>;

    export template <typename T, typename U>
    concept optional_value_three_way_comparable =
        not is_optional<std::remove_cvref_t<U>> and std::three_way_comparable_with<T, U>;
