export module std_impl.optional:make_optional;
import std;

import :optional;

export namespace std_impl::make_optional {
    [[nodiscard]] constexpr auto make_optional(auto value) -> optional::optional<std::remove_cvref_t<decltype(value)>> {
    ...
    [[nodiscard]] constexpr auto make_optional(std::initializer_list<U> list, Args&&... args) -> optional::optional<T> {
